...
public class Encryption {
    ...
    private static SecretKeySpec createKeySpec(Cipher cipher, byte[] privateKey) {
    ...
    public Encryption(Cipher cipher, Context context) {
        this(cipher, getDefaultPrivateKey(context));
    }

    public Encryption(Cipher cipher, String privateKey) {
        this(cipher, privateKey.getBytes(CHARSET));
    }

    public Encryption(Cipher cipher, byte[] privateKey) {
        this(cipher, createKeySpec(cipher, privateKey));
    }

    public Encryption(Cipher cipher, SecretKeySpec secretKeySpec) {
        this.cipher = cipher;
