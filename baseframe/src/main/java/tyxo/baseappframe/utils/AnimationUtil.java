...
public class AnimationUtil {
     ...
     * 主界面 grid 动画
     */
    public static void setMainGridAnimtion(Context context, ViewGroup view, int animId) {
        //初始化一个布局动画
        ...
        LayoutAnimationController lac = new LayoutAnimationController(AnimationUtils.loadAnimation(context, animId));
