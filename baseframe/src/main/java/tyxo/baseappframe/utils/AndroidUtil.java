...
public class AndroidUtil {
     ...
     * 获取手机Sim卡序列号
     */
    public static String getSimSerialNumWithAppContext(Context context) {
        return getSimSerialNum(context);
    }
    ...
    public static Bundle getBundle(int what, int arg1, int arg2,
        ...
        bundle.putInt(KEY_WHAT, what);
        bundle.putInt(KEY_ARG1, arg1);
        bundle.putInt(KEY_ARG2, arg1);
        bundle.putSerializable(KEY_OBJ, obj);
        return bundle;
    }
    ...
    public Bundle getBundle(int what, int arg1, int arg2, byte[] obj) {
        ...
        bundle.putInt(KEY_ARG1, arg1);
        bundle.putInt(KEY_ARG2, arg1);
        bundle.putByteArray(KEY_OBJ, obj);
        return bundle;
    }
    ...
    public static void sendMsgBroadcst(Context ctx, String action, int what,
        ...
        intent.putExtra(KEY_ARG2, arg2);
        intent.putExtra(KEY_OBJ, obj);
        ctx.sendBroadcast(intent);
    }
...
//        Toast.makeText(context, text, Toast.LENGTH_SHORT).show();
    ...
    public static boolean isFastDoubleClick(View v, int tagId) {
        long lastClickTime = 0;
        try {
            //lastClickTime = (Long) v.getTag(R.id.tag_position);
            lastClickTime = (Long) v.getTag(tagId);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getVersionName(Context context) {
        try {
            ...
            Log.i("tyxo", "versionName : " + packInfo.versionName);
    ...
    public static boolean isAppAlive(Context context, String packageName) {
        ...
        Log.i("tyxo NotificationLaunch", String.format("the %s is not running, isAppAlive return false", packageName));
        return false;
    }
    ...
    public static String getLocalMacAddressFromBusybox() {
        ...
        if (result.length() > 0 && result.contains("HWaddr") == true) {
            ...
            Log.v("tyxo", "Mac:" + Mac + " Mac.length: " + Mac.length());
            ...
            result = Mac;
            Log.v("tyxo", result + " result.length: " + result.length());
        }
        return result;
    }
    ...
    private static String callCmd(String cmd, String filter) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null && line.contains(filter) == false) {
                //result += line;
                Log.v("tyxo", "line: " + line);
            }

            result = line;
            Log.v("tyxo", "result: " + result);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
    ...
    public static String getLocalIpAddress() {
        try {
            ...
            Log.e("tyxo WifiPreference IpAddress", ex.toString());
        }
        return null;
    }
