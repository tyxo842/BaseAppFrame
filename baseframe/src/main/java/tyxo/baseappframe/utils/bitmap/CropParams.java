...
/**
* @author ly
* @created at 2016/9/20 15:42
* @des :Increase the default output size from 200 to 300.
 *      Add "scaleUpIfNeeded" crop options for scaling up cropped images if the size is too small.
 *      Add enable to toggle on/off the crop function.
 *      Add compress options to avoid OOM or other problems.
 *      Add default compress width & height.
*/
