...
/**
* @author tyxo
* @created at 2016/9/20 15:40
* @des :Add "scaleUpIfNeeded" crop options for scaling up cropped images if the size is too small.
 *      Fixed the error that crop from gallery doest work on some Kitkat devices.
 *      Add support to pick or capture photo without crop.
 *      Add compress features.
*/
public class CropHelper {

    public static final String TAG = "tyxo CropHelper";
