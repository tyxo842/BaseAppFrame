...
public abstract class BaseActivityToolbar extends AppCompatActivity {
	 ...
	 */
	protected void beforeSuper() { }//requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	public void onCreateCustomToolbar(Toolbar toolbar){
		...
		if (getSupportActionBar() != null) {
			...
			//getSupportActionBar().setHomeAsUpIndicator(R.drawable.icon_return);//设置自定义返回键
		}
	}
	...
	public void finish() {
		super.finish();
		this.overridePendingTransition(R.anim.slide_right_in,R.anim.slide_right_out);//设置切换动画
	}

	@Override
	public void startActivity(Intent intent) {
		super.startActivity(intent);
		this.overridePendingTransition(R.anim.slide_left_in,R.anim.slide_left_out);//设置切换动画
	}
}
